...
router.post("/signup", (req, res, next) => {
  const { username, password, firstname, lastname, address, city, usstate, zip, type } = req.body
  ...
  User.findOne({ username })
    .then(userDoc => {
      ...
      const newUser = new User({ username, password: hashPass, firstname, lastname, address, city, usstate, zip, type })
      return newUser.save()
    })
    .then(userSaved => {
      // LOG IN THIS USER
